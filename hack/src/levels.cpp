    ...
    BASE_ADDR(BASE_ADDR)
{
    for (size_t i = 0; i < 32; i++) {
        ...
        //
        _levelKitCount[i] = *((BYTE**)(BASE_ADDR + 0x006CA830)) + (-0x4C3 + i*0x0C);
        //
        _levelRedBrick[i] = *((BYTE**)(BASE_ADDR + 0x006CA830)) + (-0x4C1 + i*0x0C);
    }
    _hostages = *((DWORD32**)(BASE_ADDR + 0x006AF8B0)) + 0x240; // 4 bytes. at least 32bits
